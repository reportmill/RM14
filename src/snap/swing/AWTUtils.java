...
public class AWTUtils {
    ...
    public static final int    COMMAND_MASK = SnapUtils.isApp? Toolkit.getDefaultToolkit().getMenuShortcutKeyMask() : 0;
 ...
 */
public static boolean isCommandDown(InputEvent anEvent)  { return (anEvent.getModifiers() & COMMAND_MASK)>0; }
...
public static Image getImageForString(String aString, Font aFont)
{
    ...
    javax.swing.JLabel label = new javax.swing.JLabel(aString);
    label.setFont(aFont);
    label.setSize(label.getPreferredSize());

    // Create and paint image and return
