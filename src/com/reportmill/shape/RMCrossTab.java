...
void setColumnsWidth()
{
    ...
    double w = getWidth(); if(RMMath.equals(w, cw)) return;
...
void setRowsHeight()
{
    ...
    double h = getHeight(); if(RMMath.equals(h, rh)) return;
 ...
 */
protected void addPropNames() { addPropNames("Objects"); super.addPropNames(); }
