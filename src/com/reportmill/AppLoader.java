...
public class AppLoader {
    ...
    static final String JarName = "RMStudio14.jar";
    static final String JarURL = "http://reportmill.com/rm14/RMStudio14.jar.pack.gz";
    static final String LoaderJarName = "AppLoader.jar"; // 
    static final String MainClass = "com.reportmill.App";
