 ...
 */
public class Query extends SnapObject implements JSONArchiver.GetKeys, PropertyChangeListener {
...
public void setCondition(Condition aCondition)
{
    ...
    if(_condition!=null) _condition.removePropertyChangeListener(this);
    if(aCondition!=null) aCondition.addPropertyChangeListener(this);
    
    // Set condition and fire property change
    firePropertyChange(Condition_Prop, _condition, _condition = aCondition, -1);
}
...
public void addSort(Sort aSort, int anIndex)
{
    ...
    firePropertyChange(Sort_Prop, null, aSort, anIndex);
}
...
public Sort removeSort(int anIndex)
{
    ...
    firePropertyChange(Sort_Prop, sort, null, anIndex);
    return sort;
}
