...
public static void main(String args[])
{
    ...
    //System.out.println(com.reportmill.base.RMKeyChain.getValue(new Object(), "1+1*2+3"));
    //System.out.println(com.reportmill.base.RMKeyChain.getValue(new Object(), "1+2"));
