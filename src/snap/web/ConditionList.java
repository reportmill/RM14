 ...
 */
public class ConditionList extends Condition implements PropertyChangeListener {
...
public ConditionList addCondition(Operator anOperator, Condition aCondition, int anIndex)
{
    ...
    aCondition.addPropertyChangeListener(this);
    firePropertyChange(Condition_Prop, null, aCondition, anIndex);
    return this;
}
...
public Condition removeCondition(int anIndex)
{
    ...
    firePropertyChange(Condition_Prop, condition, null, anIndex);
    return condition;
}
...
public void setOperator(Operator anOperator, int anIndex)
{
    ...
    firePropertyChange(Operator_Prop, oldValue, anOperator, anIndex);
}
