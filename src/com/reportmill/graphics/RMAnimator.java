 ...
 */
public class RMAnimator extends SnapObject implements XMLArchiver.Archivable {
 ...
 * For example: Loop, Loop:5, Loop:5,3, Page:Next, Page:Last, etc.
 */
 ...
 */
public void setLoops(boolean aValue)  { setEndAction(aValue? "Loop" : ""); }
...
public XMLElement toXML(XMLArchiver anArchiver)
{
    ...
    if(getEndAction()!=null && !getEndAction().equals("Loop")) e.add("end-action", getEndAction());
...
public Object fromXML(XMLArchiver anArchiver, XMLElement anElement)
{
    ...
    if(anElement.hasAttribute("end-action")) setEndAction(anElement.getAttributeValue("end-action"));
