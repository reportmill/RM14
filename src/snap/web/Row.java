 ...
 */
public class Row extends HashMap <String,Object> implements PropertyChangeListener, GetKeys, GetValue, SetValue {

    // The WebSite that provided this row
    WebSite                   _site;
    ...
    PropertyChangeListener    _propChangeListener;
...
{
    if(_propChangeListener!=null && aListener!=null) throw new RuntimeException("Row: Need real Listener support");
    _propChangeListener = aListener;
}

/**
 * Remove a property change listener.
 */
public void removePropertyChangeListener(PropertyChangeListener aListener)  { _propChangeListener = null; }
...
{
    if(_propChangeListener==null) return;
    _propChangeListener.propertyChange(new PropertyChangeEvent(this, aPropName, anOldVal, aNewVal));
}
