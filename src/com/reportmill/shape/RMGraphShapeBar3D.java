...
public void addGridLineMajor(RMLineShape aLine)
{
    ...
    _gridWithoutSeparator.moveTo(aLine.getX(), aLine.getY());
    _gridWithoutSeparator.lineTo(aLine.getFrameMaxX(), aLine.getFrameMaxY());
}
...
protected void layoutChildren()
{
    ...
    RMRect gridRect = _vertical? new RMRect(0, _gridWithoutSeparator.getY(), getDepth(), _gridWithoutSeparator.getHeight()) :
        new RMRect(_gridWithoutSeparator.getX(), 0, _gridWithoutSeparator.getWidth(), getDepth());
    RMRect gridMinorRect = _vertical? new RMRect(0, _gridMinor.getY(), getDepth(), _gridMinor.getHeight()) :
        new RMRect(_gridMinor.getX(), 0, _gridMinor.getWidth(), getDepth());
    ...
    // Configure grid
    RMPath sideGridPath = _gridWithoutSeparator.getPathInRect(gridRect);
