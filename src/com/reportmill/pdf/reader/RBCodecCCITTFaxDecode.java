...
public static byte[] bytesForCCITTFaxDecode(byte bytes[], int offset, int len,
          int K, int rows, int columns, 
          boolean byteAligned, boolean eolRequired, boolean eoblockRequired,
          boolean blackIsOne, int allowedDamagedRows)
{
    RBCodecCCITTFaxDecode ccittFaxDecode = new RBCodecCCITTFaxDecode(bytes, offset, K, rows, columns, allowedDamagedRows, 
...
/** main constructor */
public RBCodecCCITTFaxDecode(byte bits[], int offset, int k, int rows, int columns, int numdamagedrows, 
