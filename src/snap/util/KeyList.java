...
public int size()
{
    ...
    if(_sizeMethod!=null)
        ...
        catch(Exception e) { throw new InvalidKeyListException(_sizeMethod.getName() + ": " + ClassUtils.getClassSimpleName(e) + " " + e.getCause().getMessage()); }
...
public Object get(int anIndex)
{
    ...
    if(_getMethod!=null)
        ...
        catch(Exception e) { throw new InvalidKeyListException(_getMethod.getName() + ": " + ClassUtils.getClassSimpleName(e) + " " + e.getCause().getMessage()); }
