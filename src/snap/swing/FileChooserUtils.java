 ...
 */
public static String showChooser(boolean save, JComponent aComp, String aDesc, String ... theExtensions)
{
    ...
    if(file.isDirectory())
        return showChooser(save, aComp, aDesc, theExtensions);
    ...
    if(save && file.exists()) {
        ...
        int answer = dbox.showOptionDialog(aComp, "Replace");
