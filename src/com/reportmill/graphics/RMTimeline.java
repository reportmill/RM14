 ...
 */
public class RMTimeline extends SnapObject implements PropertyChangeListener {
...
public void addKeyFrame(RMKeyFrame aKeyFrame, int anIndex)
{
    ...
    aKeyFrame.addPropertyChangeListener(this);
    ...
    firePropertyChange("KeyFrame", null, aKeyFrame, anIndex);
}
...
public RMKeyFrame removeKeyFrame(int anIndex)
{
    ...
    kframe.removePropertyChangeListener(this);
    ...
    // Fire property change
    firePropertyChange("KeyFrame", kframe, null, anIndex);
...
public void toXML(XMLArchiver anArchiver, XMLElement anElement)
{
    ...
    for(RMKeyFrame kframe : getKeyFrames()) {
        ...
        for(RMKeyValue kval : kframe.getKeyValues()) {
            ...
            RMInterpolator interp = kval.getInterpolator();
            if(interp!=null) {
                if(interp.isShared()) kvalXML.add("interpolator", interp.getName());
                else kvalXML.add(anArchiver.toXML(interp));
            }
