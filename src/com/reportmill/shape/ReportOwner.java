 ...
 */
public Object peekDataStack()  { return RMListUtils.getLast(_dataStack); }
 ...
 */
public void addPageReferenceShape(RMShape aShape)  { RMListUtils.addUniqueId(_pageRefShapes, aShape); }
...
public List getKeyChainListValue(String aKeyChain)
{
    ...
    if(list==null && !RMUtils.equals(aKeyChain, "RMDefaultObjectList"))
...
{
    if(key.equals("RMRandom")) return RMMath.randomInt();
    if(key.equals("RMVersion"))
        return "ReportMill " + RMUtils.getVersion() + " (Build Date: " + RMUtils.getBuildInfo() + ")";
    ...
    if(key.equals("RMFlowers")) return getClass().getResource("/snap/swing/ColorPanel.ribs/tulips.jpg");
    return null;
}
