 ...
 */
public RMColor getFillColor()  { return _gstate.fillColor; }

/**
 * Sets the fill color.
 */
public void setFillColor(RMColor aColor)  { _gstate.fillColor = aColor; }

/**
 * Returns the stroke color.
 */
public RMColor getStrokeColor()  { return _gstate.strokeColor; }

/**
 * Sets the stroke color.
 */
public void setStrokeColor(RMColor aColor)  { _gstate.strokeColor = aColor; }

/**
 * Returns the stroke width.
 */
public float getStrokeWidth()  { return _gstate.strokeWidth; }

/**
 * Sets the stroke width.
 */
public void setStrokeWidth(float aWidth)  { _gstate.strokeWidth = aWidth; }
 ...
 */
public float getFillOpacity()  { return _gstate.fillOpacity; }

/**
 * Sets the fill opacity.
 */
public void setFillOpacity(float anOpacity)  { _gstate.fillOpacity = anOpacity; }

/**
 * Returns the stroke opacity.
 */
public float getStrokeOpacity()  { return _gstate.strokeOpacity; }

/**
 * Sets the stroke opacity.
 */
public void setStrokeOpacity(float anOpacity)  { _gstate.strokeOpacity = anOpacity; }

/**
 * Returns the shape opacity.
 */
public float getShapeOpacity()  { return _gstate.shapeOpacity; }

/**
 * Sets the shape opacity.
 */
public void setShapeOpacity(float anOpacity)  { _gstate.shapeOpacity = anOpacity; }
...
public static class GState implements Cloneable {
    ...
    // The fill color
    RMColor     fillColor = null;
    
    // The stroke color
    RMColor     strokeColor = null;
