...
class HyphenDict {
    ...
    private void loadHyphenDict() throws IOException
    {
        ...
        byte bytes[] = RMUtils.getBytes(getClass().getResourceAsStream("hyph_en_US.dic"));
        ...
        for(int i=0; i<bytes.length; i++) {
            ...
            if(bytes[i]=='\n') {
                ...
                charset = RMStringUtils.delete(charset, "charset "); // some dicts start with "charset " - don't know why
                break;
            }
        }
