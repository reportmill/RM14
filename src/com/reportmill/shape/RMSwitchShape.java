...
public void setVersion(String aName)
{
    ...
    firePropertyChange("Version", _version, _version = aName, -1);
 ...
 */
protected void addPropNames() { addPropNames("Version"); super.addPropNames(); }
...
public void paintShape(RMShapePainter aPntr)
{
    ...
    if(getClass()==RMSwitchShape.class && getStroke()==null && aPntr.isEditing()) {
        aPntr.setColor(Color.lightGray); aPntr.setStroke(RMAWTUtils.Stroke1);
...
public RMSwitchShape clone()
{
    ...
    clone.setChildAnimator(RMUtils.clone(_childAnimator)); // Clone child animator
