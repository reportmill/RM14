 ...
 */
public class RMKeyFrame extends SnapObject implements PropertyChangeListener, Comparable<RMKeyFrame> {
...
public void addKeyValue(RMKeyValue aKeyValue, int anIndex)
{
    ...
    aKeyValue.addPropertyChangeListener(this);
    ...
    firePropertyChange("KeyValue", null, aKeyValue, anIndex);
}
...
public RMKeyValue removeKeyValue(int anIndex)
{
    ...
    kval.removePropertyChangeListener(this);
    ...
    // Fire property change
    firePropertyChange("KeyValue", kval, null, anIndex);
