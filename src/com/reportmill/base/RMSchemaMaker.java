...
private Entity getEntity(Object anObject, Class aClass, String aKey, int aDepth, Schema aSchema)
{
    ...
    for(int index = RMListUtils.indexOfId(_processed, anObject); index>=0;)
    ...
    // Get object class
    Class objClass = aClass!=null? aClass : RMClassUtils.getClass(object);
    
    // Get standard class name
    String className = aSchema.getEntityCount()==0? aKey : RMClassUtils.getClassStandardName(objClass, true);
