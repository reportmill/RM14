...
public void setMainTable(RMTable aTable)
{
    ...
    firePropertyChange("MainTable", _mainTable, _mainTable = aTable, -1);
...
public void paintShapeOver(RMShapePainter aPntr)
{
    ...
    super.paintShapeOver(aPntr); if(!aPntr.isEditing()) return;
    ...
    aPntr.drawString("Table Group", 14, (float)getHeight() - 5);
}
