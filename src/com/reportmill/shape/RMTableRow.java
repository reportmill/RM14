 ...
 */
public RMTable getTable()  { return RMClassUtils.getInstance(getParent(), RMTable.class); }
...
public void setStructured(boolean aFlag)
{
    ...
    firePropertyChange("Structured", _structured, _structured = aFlag, -1);
...
public void setSyncStructureWithRowAbove(boolean aFlag)
{
    ...
    // Set value and fire property change
    firePropertyChange("SyncStructureWithRowAbove", _syncStructureWithRowAbove, _syncStructureWithRowAbove = aFlag, -1);
...
public void setSyncStructureWithAlternates(boolean aFlag)
{
    ...
    // Set value and fire property change
    firePropertyChange("SyncStructureWithAlternates", _syncStructureWithAlternates, _syncStructureWithAlternates = aFlag, -1);
 ...
 */
public RMTextShape getColumn(int anIndex)  { return RMClassUtils.getInstance(getChild(anIndex), RMTextShape.class); }
...
{
    firePropertyChange("NumberOfChildrenToStayWith", _numberOfChildrenToStayWith, _numberOfChildrenToStayWith = aValue, -1);
}
...
{
    firePropertyChange("ReprintWhenWrapped", _reprintWhenWrapped, _reprintWhenWrapped = aFlag, -1);
}
...
{
    firePropertyChange("PrintEvenIfGroupIsEmpty", _printEvenIfNoObjectsInGroup, _printEvenIfNoObjectsInGroup = aFlag, -1);
}
...
{
    firePropertyChange("MoveToBottom", _moveToBottom, _moveToBottom = aFlag, -1);
}
...
{
    firePropertyChange("MinSplitHeight", _minSplitHeight, _minSplitHeight = aValue, -1);
}
...
{
    firePropertyChange("MinSplitRemainderHeight", _minSplitRemainderHeight, _minSplitRemainderHeight = aValue, -1);
}
...
{
    // Set value and fire property change
    firePropertyChange("PageBreakKey", _pageBreakKey, _pageBreakKey = aString, -1);
}
