...
public List getTokens(PDFPageParser parser) {
    if (tokens==null) {
        ...
        parser.getTokens(streamBytes, 0, streamBytes.length, tokens);
    }
    return tokens;
}
...
public Map getResources(PDFFile srcfile)  { return (Map)srcfile.resolveObject(formdict.get("Resources")); }
